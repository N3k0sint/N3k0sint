...
#### 🚀 What I'm Up To
- 🎓 **Certified:** CompTIA Security+ CE 🛡️
- 🛠️ **Building:** Open-source security tools focused on **Osint**, **Metadata** and **Digital Forensics**.
- 📚 **Learning:** Advanced Red Teaming tactics and Automated Exploit Development.
- 🤝 **Community:** Sharing technical write-ups and curated tools to help community.
- 🛡️ **Practice:** Active CTF player.

---
### 🏆 Featured Projects
| Project | Description | Tech |
| :--- | :--- | :--- |
| **[StegoPro](https://github.com/N3k0sint/StegoPro)** | High-speed LSB Image Steganography tool with Analysis suite. | Python, Tkinter, NumPy |
...
| **[Wh0hSeen!](https://wh0hseen.my)** | OSINT tool focused on the Malaysian digital landscape. | Python, Flask |
